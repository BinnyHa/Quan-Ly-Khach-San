...
namespace QuanLyKhachSan.Layout
{
    public partial class QLNhanVienControl : UserControl
    {
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            con.Open();
            DataTable dt = new DataTable();
            adapt = new SqlDataAdapter("SELECT * FROM NHANVIEN where MANHANVIEN like N'%" + txtTimkiem.Text +
                "%' or PASS like N'%" + txtTimkiem.Text + "%' or HOTEN like N'%" + txtTimkiem.Text + "%' or CHUCVU like N'%" + txtTimkiem.Text + "%' or GIOITINH like N'%" + txtTimkiem.Text + "%' or NGAYSINH like N'%" + txtTimkiem.Text + "%' or SODIENTHOAI like N'%" + txtTimkiem.Text + "%'", con);
            adapt.Fill(dt);
            dataNhanVien.DataSource = dt;
            con.Close();
        }
